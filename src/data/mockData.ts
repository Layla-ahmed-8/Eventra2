...
export const mockEvents: Event[] = [
  ...
  {
    id: 'event-weekend-1',
    title: 'Cairo Weekend Market & Festival',
    description: 'A vibrant weekend market featuring local artisans, live music, and delicious food from around Egypt.',
    ...
    location: {
      venue: 'Al-Azhar Park',
      address: 'Al-Darb Al-Ahmar, Cairo',
      city: 'Cairo',
      country: 'EG',
      lat: 30.0325,
      lng: 31.2614,
    ...
    organizer: {
      id: 'org-006',
      name: 'Cairo Community Events',
      avatar: 'https://i.pravatar.cc/150?img=60',
      verified: true,
      followerCount: 15000
    },
    price: 0,
    ticketTypes: [{ name: 'Free Entry', price: 0, available: 1000 }],
    capacity: 2000,
    rsvpCount: 890,
    tags: ['market', 'community', 'weekend', 'local'],
    isRecommended: true,
    relevanceScore: 0.9,
    ...
    engagement: {
      ...
      atmosphereLabel: 'High-energy crowd expected',
      vibeTags: ['Community builders', 'Creative crowd', 'Friendly for solo attendees'],
      activitySignals: [
        { text: 'Over 800 people attending!', icon: '🎉', timestamp: 'Just now' },
      ],
      recentAttendees: [
        { avatar: 'https://i.pravatar.cc/40?img=61', name: 'Hoda', interest: 'Community' },
      ],
      sharedInterests: ['Community', 'Local', 'Weekend'],
      discussionCount: 45,
      bookmarkCount: 180,
      reactionCount: 320,
      xpReward: 110,
      identityLabel: 'Community Member',
      aiMatchReason: 'You may connect well with community-oriented people',
      softActivityFeedback: 'Artisans are setting up their stalls',
    }
  },
  {
    id: 'event-free-1',
    title: 'Open Mic Night: Free Entry',
    description: 'Come showcase your talent or just enjoy the performances! Free entry for everyone.',
    ...
    capacity: 150,
    rsvpCount: 95,
    tags: ['open-mic', 'music', 'free', 'performance'],
    isRecommended: false,
    relevanceScore: 0.82,
    ...
    engagement: {
      ...
      vibeTags: ['Music lovers', 'Creative crowd', 'Friendly for solo attendees'],
      activitySignals: [
        { text: 'Sign-ups for performers open now!', icon: '🎤', timestamp: '1 hr ago' },
      ],
      recentAttendees: [
        { avatar: 'https://i.pravatar.cc/40?img=71', name: 'Khaled', interest: 'Music' },
      ],
      sharedInterests: ['Music', 'Performance', 'Open Mic'],
      discussionCount: 12,
      bookmarkCount: 35,
      reactionCount: 48,
      xpReward: 90,
      identityLabel: 'Music Enthusiast',
      aiMatchReason: 'Great for music lovers looking for a casual evening',
      softActivityFeedback: 'Performers are preparing their sets',
    }
  },
  {
    id: 'event-003',
  ...
  {
    id: 'event-004',
    title: 'Contemporary Art Exhibition: Cairo 2026',
    description: 'Explore cutting-edge contemporary art from Egyptian and international artists at this stunning exhibition in Zamalek.',
    ...
    organizer: {
      id: 'org-004',
      name: 'Cairo Art Collective',
      avatar: 'https://i.pravatar.cc/150?img=40',
      verified: true,
      followerCount: 5600
    },
    price: 0,
    ticketTypes: [{ name: 'Free Entry', price: 0, available: 500 }],
    capacity: 200,
    rsvpCount: 87,
    ...
    engagement: {
      ...
      vibeTags: ['Artistic vibes', 'Creative crowd', 'Networking-friendly'],
      activitySignals: [
        { text: 'New art pieces just unveiled', icon: '🎨', timestamp: '1 hr ago' },
      ],
      recentAttendees: [
        { avatar: 'https://i.pravatar.cc/40?img=41', name: 'Yara', interest: 'Art' },
      ],
      sharedInterests: ['Art', 'Contemporary', 'Culture'],
      discussionCount: 15,
      bookmarkCount: 45,
      reactionCount: 67,
      xpReward: 100,
      identityLabel: 'Art Enthusiast',
      aiMatchReason: 'You may connect well with attendees who love contemporary art',
      softActivityFeedback: 'Artists are available for Q&A',
    }
  },
  {
    id: 'event-005',
    title: 'Cairo Food Festival: Taste of Egypt',
    description: 'Indulge in the finest Egyptian cuisine from across the country at this annual food festival in Heliopolis.',
    image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800',
    category: 'Food & Drink',
    date: '2026-05-22T14:00:00Z',
    endDate: '2026-05-24T23:00:00Z',
    location: {
      venue: 'Heliopolis Club',
      address: 'El Nozha St, Heliopolis',
      city: 'Cairo',
      country: 'EG',
      lat: 30.109,
      lng: 31.325,
    ...
    price: 100,
    ticketTypes: [
      { name: 'Day Pass', price: 100, available: 300 },
      { name: 'Weekend Pass', price: 250, available: 100 }
    ],
    capacity: 1000,
    rsvpCount: 567,
    tags: ['food', 'festival', 'egyptian', 'cuisine'],
    isRecommended: true,
    relevanceScore: 0.94,
    ...
    engagement: {
      ...
      atmosphereLabel: 'High-energy crowd expected',
      vibeTags: ['Foodie paradise', 'Networking-friendly', 'High-energy'],
      activitySignals: [
        { text: 'Over 500 people attending!', icon: '🍴', timestamp: 'Just now' },
      ],
      recentAttendees: [
        { avatar: 'https://i.pravatar.cc/40?img=51', name: 'Maya', interest: 'Food' },
      ],
      sharedInterests: ['Food', 'Egyptian', 'Cuisine'],
      discussionCount: 32,
      bookmarkCount: 120,
      reactionCount: 289,
      xpReward: 130,
      identityLabel: 'Foodie',
      aiMatchReason: 'You may connect well with food enthusiasts',
      softActivityFeedback: 'Cooking demonstrations happening now',
    }
  },
  {
    id: 'event-011',
