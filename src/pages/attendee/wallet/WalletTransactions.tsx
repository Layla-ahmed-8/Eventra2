...
const typeConfig: Record<string, { label: string; color: string }> = {
  ...
  payout:     { label: 'Payout',     color: 'text-red-500' },
  fee:        { label: 'Fee',        color: 'text-orange-500' },
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-body text-muted-foreground mt-1">All your wallet activity in one place.</p>
      </div>
      ...
      <div className="surface-panel">
        {transactions.length === 0 ? (
          <div className="text-center py-16 text-muted-foreground">
            ...
            <p className="text-body-sm mt-1">Try changing the filter above.</p>
          </div>
        ) : (
