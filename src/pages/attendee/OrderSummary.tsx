...
import { ArrowLeft, Calendar, MapPin, Download, Share2, QrCode, Clock, Users, BadgeCheck } from 'lucide-react';
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 space-y-8">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-50">
                <div className="relative">
                  ...
                  {event.organizer.verified && (
                    <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#6C4CF1] rounded-full flex items-center justify-center">
                      <BadgeCheck className="w-3 h-3 text-white" />
                    </div>
                  )}
                </div>
                <div>
                  <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Organized By</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3 p-4 rounded-xl bg-gray-50">
                  <Calendar className="w-5 h-5 text-[#6C4CF1] mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-xl bg-gray-50">
                  {event.location.isVirtual ? (
                    <div className="flex items-start gap-3">
                      <div className="w-5 h-5 text-[#6C4CF1] mt-0.5 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg>
                      </div>
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <MapPin className="w-5 h-5 text-[#6C4CF1] mt-0.5" />
                      <div>
              ...
              {/* About */}
              <div>
                <h4 className="text-lg font-bold text-gray-900 mb-3">About This Event</h4>
              ...
              {event.schedule && event.schedule.length > 0 && (
                <div>
                  ...
                  <div className="space-y-0 relative before:absolute before:left-[15px] before:top-2 before:bottom-2 before:w-px before:bg-gray-200">
                    {event.schedule.map((item: any, idx: number) => (
                      <div key={idx} className="relative pl-11 pb-6 last:pb-0">
                        <div className={cn(
                          "absolute left-0 top-1 w-8 h-8 rounded-lg flex items-center justify-center z-10",
                          item.active
                        ...
                        <div>
                          <p className={cn(
                            ...
                            item.active ? "text-[#6C4CF1]" : "text-gray-500"
                          )}>
                            {item.time}
                          </p>
